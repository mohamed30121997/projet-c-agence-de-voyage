...
gtk_container_add(GTK_CONTAINER(authentification), GTK_WIDGET(table1));
image6 = create_pixmap (authentification, "1.jpg");
image6=gtk_image_new_from_file("./1.jpg");
gtk_table_attach_defaults(GTK_TABLE(table1), image6, 0, 0,0,0); //0,0
gtk_widget_show_all(authentification);
crud=lookup_widget(objet_graphique,"crud");
login=lookup_widget(objet_graphique,"login1");
password=lookup_widget(objet_graphique,"password1");
...
f=fopen("/home/bilell/Projects/offre.2/offre.txt","r");
...
fclose(f);	
	...
	{f=fopen("/home/bilell/Projects/offre.2/offre.txt","a+");
	if(f!=NULL)
	{
...
GtkWidget *notebook;
GtkWidget *crud;
crud=lookup_widget(button,"crud");
notebook=lookup_widget(crud,"notebook1");
...
f=fopen("/home/bilell/Projects/offre.2/offre.txt","r");
fich=fopen("/home/bilell/Projects/offre.2/tempoffre.txt","w");
while(fscanf(f,"%s %s %s %s %s %s %s %s %s %s %s %s ",a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12)!=EOF)
{
if(strcmp(a13,a1)==0)
{
...
fclose(f);
fclose(fich);
remove("/home/bilell/Projects/offre.2/offre.txt");
rename("/home/bilell/Projects/offre.2/tempoffre.txt","/home/bilell/Projects/offre.2/offre.txt");
FILE* fichier = NULL;

fichier = fopen("/home/bilell/Projects/offre.2/tempoffre.txt", "w");
if (fichier != NULL)
{
fputs("", fichier);
fclose(fichier);
