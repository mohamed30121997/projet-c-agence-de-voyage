...
FILE *pf;
f=fopen("/home/bilell/Projects/offre.2/offre.txt","r");
pf=fopen("/home/bilell/Projects/offre.2/offresup.txt","w+");
while(fscanf(f,"%s %s %s %s %s %s %s %s %s %s %s %s ",id,titre,jour1,mois1,an1,jour2,mois2,an2,hotel,categ,detail,prix)!=EOF)
{
...
pf=fopen("/home/bilell/Projects/offre.2/offresup.txt","r");
f=fopen("/home/bilell/Projects/offre.2/offre.txt","w+");
